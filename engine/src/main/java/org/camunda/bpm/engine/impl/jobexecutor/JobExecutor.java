...
public abstract class JobExecutor {
  ...
  protected boolean prioritizedAcquisition = false;
  protected int priorityElevationPerMinute = 1;
  ...
  public boolean isPrioritizedAcquisition() {
    return prioritizedAcquisition;
  }

  public void setPrioritizedAcquisition(boolean prioritizedAcquisition) {
    this.prioritizedAcquisition = prioritizedAcquisition;
  }

  public int getPriorityElevationPerMinute() {
    return priorityElevationPerMinute;
  }

  public void setPriorityElevationPerMinute(int priorityElevationPerMinute) {
    this.priorityElevationPerMinute = priorityElevationPerMinute;
  }
