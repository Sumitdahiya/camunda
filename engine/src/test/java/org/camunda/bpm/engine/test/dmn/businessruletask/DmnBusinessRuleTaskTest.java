...
public class DmnBusinessRuleTaskTest extends PluggableProcessEngineTestCase {
  ...
  @Deployment(resources = { DECISION_PROCESS, DECISION_OKAY_DMN })
  ...
  @Deployment(resources = { DECISION_PROCESS_LATEST, DECISION_PROCESS_EXPRESSION, DECISION_OKAY_DMN })
  public void testDecisionRefLatestBinding() {
    ...
    processInstance = startExpressionProcess("latest");
  ...
  @Deployment(resources = { DECISION_PROCESS_DEPLOYMENT, DECISION_PROCESS_EXPRESSION, DECISION_OKAY_DMN })
  public void testDecisionRefDeploymentBinding() {
    ...
    processInstance = startExpressionProcess("deployment");
  ...
  public void testDecisionRefVersionBinding() {
    ...
    processInstance = startExpressionProcess("version", 2);
  ...
  protected ProcessInstance startExpressionProcess(Object binding) {
    return startExpressionProcess(binding, null);
  }

  protected ProcessInstance startExpressionProcess(Object binding, Object version) {
    return startExpressionProcess("testDecision", binding, version);
  }

  protected ProcessInstance startExpressionProcess(Object decisionKey, Object binding, Object version) {
    VariableMap variables = Variables.createVariables()
        .putValue("decision", decisionKey)
        .putValue("binding", binding)
