...
public class HalLinker {
  ...
  protected final Hal halContext;
  ...
  public HalLinker(Hal halContext, HalResource<?> resource) {
  ...
  public List<HalResource<?>> resolve(HalRelation relation, ProcessEngine processEngine) {
    HalLinkResolver linkResolver = halContext.getLinkResolver(relation.resourceType);
