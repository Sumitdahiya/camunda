...
public interface PvmAtomicOperation extends CoreAtomicOperation<PvmExecutionImpl>, AtomicOperation {
  ...
  PvmAtomicOperation ACTIVITY_START_INTERRUPT_SCOPE = new PvmAtomicOperationActivityStartInterruptScope();
  ...
  PvmAtomicOperation TRANSITION_INTERRUPT_SCOPE = new PvmAtomicOperationsTransitionInterruptScope();
